...
//    ...do your stuff here...
// });
var person = new Person({ name: "Budiman", age: 20, favoriteFoods: ["fish", "banana"] });
...
createAndSavePerson(function(err, result) {
  if (err)
    console.log(err);
  console.log(result);
});
...
createManyPeople([
  { name: "Mary", age: 20, favoriteFoods: ["food 1", "burrito"] },
  { name: "Person 2", age: 23, favoriteFoods: ["food 5", "burrito"] },
  { name: "Angel", age: 23, favoriteFoods: ["food 3", "burrito"] }  
], function(err, result) {
  if (err)
    console.log(err);
  console.log(result);
...
var findPeopleByName = function(personName, done) {
 Person.find({name: personName}, function(err, persons) {
   if (err)
    done(err);
   done(null, persons);
 });
...
// findPeopleByName('Budiman', function (err, result) {
//   if (err)
//     console.log(err);
...
var findOneByFood = function(food, done) {
 ...
 Person.findOne({favoriteFoods: food}, function(err, persons) {
   if (err)
    done(err);
   done(null, persons);
 });
...
// findOneByFood('food 2', function(err, result) {
//   if (err)
//     console.log(err);
//   console.log('result findOneByFood: ', result);  
// });
...
// findPersonById('5ec1589c3579dd26935d261b', function (err, result) {
//   if (err)
//     console.log(err);
//   console.log('result findPersonById: ', result);
// });
...
// findEditThenSave('5ec1589c3579dd26935d261b', function (err, result) {
//   if (err)
//     console.log(err);
//   console.log('result findEditThenSave: ', result);
// });
...
// findAndUpdate('Person 2', function (err, result) {
//   if (err)
//     console.log(err);
//   console.log('result findAndUpdate: ', result);
// });
...
// removeById('5ec16174323a2648afbbc72b', function (err, result) {
//   if (err)
//     console.log(err);
...
// removeManyPeople(function(err, result) {
//   if (err)
//     console.log(err);
//   console.log('removeManyPeople: ', result);
// });  
...
queryChain(function (err, result) {
  if (err)
    console.log(err);
  console.log('queryChain : ', result);
});
